...
- `CabInvoiceApp.java`: Cab fare calculator for normal and premium rides.
- `InterfaceInThreeClass.java`: Demonstrates interface usage across multiple classes.

#### ✅ Workshop 03 — E-Wallet Application
Built a fully functional **E-Wallet system** that:
- Supports money loading and transfer
- Distinguishes between personal and business wallets
...
- Arrays (1D & 2D)
- Methods (declaration, overloading, return types)
...
Dedicated to **Object-Oriented Programming** principles and real-world modeling using Java.

#### Topics Covered:
- Class and Object Design
- Constructors and Access Modifiers
- `this`, `static`, `final`, and `instanceof` operators
- Object Modeling & Class Diagrams (UML)
...
Focuses on **Data Structures and Algorithms** to enhance coding performance and problem-solving skills.
